...
contract PupperCoinSale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, RefundablePostDeliveryCrowdsale {
    ...
    constructor(
        ...
        uint rate, // TKNbits rate
        address payable wallet, // sale beneficiary
        PupperCoin token, // Puppercoin that will work with PupperCoinSale
        uint cap,
        uint open,
        uint close,
        uint goal 
...
contract PupperCoinSaleDeployer {
    ...
    constructor(
        ...
        address payable wallet, // wallet receives raised ETH 
        uint goal
    )
        public
    {
        // Creating PupperCoin and address
